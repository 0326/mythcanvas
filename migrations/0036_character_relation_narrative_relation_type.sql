-- Allow package-owned narrative relation semantics in the generic graph.
-- The relation table has a CHECK constraint, so rebuild it rather than
-- silently coercing a source assertion into a different relation type.

CREATE TABLE character_relations__narrative_relation_type (
  id TEXT PRIMARY KEY,
  ...
  relation_type TEXT NOT NULL
    CHECK (relation_type IN (
      ...
      'companion', 'encounters', 'resists', 'departs-from'
    )),
...
INSERT INTO character_relations__narrative_relation_type (
...
ALTER TABLE character_relations__narrative_relation_type RENAME TO character_relations;
