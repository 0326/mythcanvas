...
INSERT OR IGNORE INTO worlds (id, mythology_id, slug, name, name_en, summary, canonical_design_json) VALUES
('world-heavenly-palace','myth-chinese','heavenly-palace','三十三重天','Celestial Palace','层叠宫阙悬于云海之上，玉阶、金阙与天门连接不同天境。','{"anchors":["层叠宫阙","云海中轴","月轮/日轮","玉阶天门"],"silhouette":"高低错落的东方宫殿群围绕中央天门向上生长","signatureMaterials":["白玉","鎏金","云雾"]}'),
('world-olympus','myth-greek','olympus','奥林匹斯','Olympus','悬于高峰与云层之上的诸神居所，以白色神殿和黄金光线为核心。','{"anchors":["白色柱廊","高山云层","黄金穹顶","诸神议庭"],"signatureMaterials":["大理石","黄金"]}'),
('world-asgard','myth-norse','asgard','阿斯加德','Asgard','由巨石、金属与彩虹桥连接的北境神域，远方世界树贯穿天际。','{"anchors":["世界树","彩虹桥","北境宫殿","极光天空"],"signatureMaterials":["巨石","铁","冰晶"]}'),
('world-takamagahara','myth-japanese','takamagahara','高天原','Takamagahara','月色与云层之间的神圣原野，鸟居和神社隐于幽静雾林。','{"anchors":["月轮","鸟居","神社屋顶","雾林"],"signatureMaterials":["木","石","和纸"]}'),
('world-duat','myth-egyptian','duat','杜阿特','Duat','太阳神舟穿越的冥界神域，砂岩巨门与星空构成昼夜交界。','{"anchors":["太阳圆盘","神舟","砂岩巨门","星空穹顶"],"signatureMaterials":["砂岩","黑石","青金石"]}');
...
('character-change','world-heavenly-palace'),
('character-athena','world-olympus'),
('character-freyja','world-asgard'),
('character-kaguya','world-takamagahara'),
('character-anubis','world-duat');
