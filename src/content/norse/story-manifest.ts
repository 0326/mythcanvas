...
import { norseStoryDependencyPlan } from './story-dependency-plan';
...
const item = (seed: Seed): NorseStoryManifestItem => {
  ...
  return {
    ...
    expectedDependencies: {
      ...
      world: norseStoryDependencyPlan[seed.slug]?.world ?? [],
      scene: norseStoryDependencyPlan[seed.slug]?.scene ?? [],
...
export const norseStoryManifest: readonly NorseStoryManifestItem[] = [
  ...
  item({ slug: 'ask-and-embla', zh: '阿斯克与恩布拉', en: 'Ask and Embla', cycle: 'creation', priority: 'P0', source: 'voluspa', locator: 'st. 17–18', characters: ['character-odin', 'character-honir', 'character-lodur'], existingStoryId: 'story-ask-and-embla', migrationDecision: 'rewrite' }),
  ...
  item({ slug: 'aesir-vanir-truce', zh: '阿萨与华纳的和约', en: 'The Æsir–Vanir Truce', cycle: 'gods-and-treasures', priority: 'P0', source: 'proseEddaSkaldskaparmal', locator: 'ch. 57', characters: ['character-njordr', 'character-freyr', 'character-freyja'], existingStoryId: 'story-aesir-vanir-truce', migrationDecision: 'split' }),
  ...
  // Cycle 04 — Thor
  item({ slug: 'thor-and-hrungnir', zh: '索尔与赫朗格尼尔', en: 'Thor and Hrungnir', cycle: 'thor-cycle', priority: 'P0', source: 'proseEddaSkaldskaparmal', locator: 'ch. 17', characters: ['character-thor', 'character-hrungnir'], existingStoryId: 'story-thor-and-hrungnir', migrationDecision: 'rewrite' }),
  ...
  item({ slug: 'thor-and-geirrod', zh: '索尔与盖尔罗德', en: 'Thor and Geirröðr', cycle: 'thor-cycle', priority: 'P0', source: 'thorsdrapa', locator: 'sts. 1–3, 5–23; Geirröðr sequence', characters: ['character-thor', 'character-geirrod', 'character-gjalp', 'character-greip'], objects: ['object-norse-megingjord', 'object-norse-jarngreipr'], existingStoryId: 'story-thor-and-geirrod', migrationDecision: 'rewrite' }),
  ...
  item({ slug: 'sigurds-death', zh: '西格尔德之死', en: 'The Death of Sigurd', cycle: 'volsung-cycle', priority: 'P0', source: 'sigurdarkvida', locator: 'Sigurðarkviða en skamma sts. 22–24, 29–31; compare Brot af Sigurðarkviðu st. 4', characters: ['character-sigurd', 'character-brynhildr', 'character-gudrun', 'character-gunnar', 'character-hogni'], existingStoryId: 'story-sigurds-death', migrationDecision: 'rewrite' }),
