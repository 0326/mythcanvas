...
export const norseStoryManifest: readonly NorseStoryManifestItem[] = [
  ...
  item({ slug: 'norns-at-urdarbrunnr', zh: '诺恩与命运之井', en: 'The Norns at Urðarbrunnr', cycle: 'creation', priority: 'P0', source: 'voluspa', locator: 'st. 20', characters: ['character-urd', 'character-verdandi', 'character-skuld'] }),
  ...
  item({ slug: 'nidhoggr-and-world-tree', zh: '尼德霍格与世界树', en: 'Níðhöggr and the World Tree', cycle: 'creation', priority: 'P1', source: 'grimnismal', locator: 'st. 32–35', characters: ['character-nidhoggr'] }),
  ...
  item({ slug: 'odin-steals-mead', zh: '奥丁夺取诗歌蜜酒', en: 'Odin Steals the Mead of Poetry', cycle: ['gods-and-treasures', 'odin-cycle'], priority: 'P0', source: 'proseEddaSkaldskaparmal', locator: 'ch. 1', characters: ['character-odin'], objects: ['object-norse-mead-of-poetry'] }),
  ...
  item({ slug: 'skadi-compensation', zh: '斯卡蒂的赔偿', en: 'Skaði’s Compensation', cycle: 'gods-and-treasures', priority: 'P0', source: 'proseEddaGylfaginning', locator: 'ch. 23', characters: ['character-skadi', 'character-njordr'] }),
  item({ slug: 'njordr-and-skadi', zh: '尼约德与斯卡蒂的婚姻', en: 'Njörðr and Skaði', cycle: 'gods-and-treasures', priority: 'P0', source: 'proseEddaGylfaginning', locator: 'ch. 23', characters: ['character-njordr', 'character-skadi'] }),
  ...
  item({ slug: 'odin-and-vafthrudnir', zh: '奥丁与瓦夫苏鲁德尼尔', en: 'Odin and Vafþrúðnir', cycle: 'odin-cycle', priority: 'P0', source: 'vafthrudnismal', locator: 'st. 1–55', characters: ['character-odin', 'character-vafthrudnir'] }),
  item({ slug: 'grimnir-revealed', zh: '格里姆尼尔的启示', en: 'Grímnir Revealed', cycle: 'odin-cycle', priority: 'P0', source: 'grimnismal', locator: 'st. 1–54', characters: ['character-odin'] }),
  item({ slug: 'odin-ravens', zh: '胡金与穆宁', en: 'Huginn and Muninn', cycle: 'odin-cycle', priority: 'P1', source: 'grimnismal', locator: 'st. 20', characters: ['character-odin', 'character-huginn', 'character-muninn'] }),
  item({ slug: 'valholl-and-valkyries', zh: '瓦尔哈拉与女武神', en: 'Valhöll and the Valkyries', cycle: 'odin-cycle', priority: 'P0', source: 'grimnismal', locator: 'st. 8–13, 36', characters: ['character-odin'] }),
  item({ slug: 'odin-seidr', zh: '奥丁与塞德魔法', en: 'Odin and Seiðr', cycle: 'odin-cycle', priority: 'P1', source: 'ynglingaSaga', locator: 'ch. 7', characters: ['character-odin', 'character-freyja'] }),
  ...
  item({ slug: 'thor-and-hymir', zh: '索尔与海米尔的大锅', en: 'Thor and Hymir’s Cauldron', cycle: 'thor-cycle', priority: 'P0', source: 'hymiskvida', locator: 'st. 1–39', characters: ['character-thor', 'character-hymir'] }),
  ...
  item({ slug: 'thor-and-thjalfi-roskva', zh: '索尔、夏尔菲与罗丝克瓦', en: 'Thor, Þjálfi and Röskva', cycle: 'thor-cycle', priority: 'P1', source: 'proseEddaGylfaginning', locator: 'ch. 44', characters: ['character-thor', 'character-thjalfi', 'character-roskva'] }),
  item({ slug: 'thor-and-skrymir', zh: '索尔与斯克里米尔', en: 'Thor and Skrymir', cycle: 'thor-cycle', priority: 'P0', source: 'proseEddaGylfaginning', locator: 'ch. 45', characters: ['character-thor', 'character-loki', 'character-skrymir'] }),
  ...
  item({ slug: 'thor-and-alviss', zh: '索尔与阿尔维斯', en: 'Thor and Alvíss', cycle: 'thor-cycle', priority: 'P1', source: 'alvissmal', locator: 'st. 1–35', characters: ['character-thor', 'character-alviss'] }),
  item({ slug: 'thor-and-harbard', zh: '索尔与哈巴德', en: 'Thor and Hárbarðr', cycle: 'thor-cycle', priority: 'P1', source: 'harbardsljod', locator: 'st. 1–60', characters: ['character-thor', 'character-odin'] }),

  // Cycle 05 — Loki
  item({ slug: 'loki-and-angrboda', zh: '洛基与安格尔伯达', en: 'Loki and Angrboða', cycle: 'loki-cycle', priority: 'P0', source: 'proseEddaGylfaginning', locator: 'ch. 34', characters: ['character-loki', 'character-angrboda', 'character-fenrir', 'character-jormungandr', 'character-hel'] }),
  ...
  item({ slug: 'loki-and-baldr', zh: '洛基与巴德尔之死', en: 'Loki and Baldr’s Death', cycle: ['loki-cycle', 'baldr-ragnarok'], priority: 'P0', source: 'proseEddaGylfaginning', locator: 'ch. 49', characters: ['character-loki', 'character-baldr', 'character-hodr', 'character-frigg'] }),
  ...
  item({ slug: 'loki-at-ragnarok', zh: '洛基在诸神黄昏', en: 'Loki at Ragnarök', cycle: ['loki-cycle', 'baldr-ragnarok'], priority: 'P0', source: 'voluspa', locator: 'st. 46–51', characters: ['character-loki', 'character-heimdall'] }),
  ...
  item({ slug: 'vali-avenges-baldr', zh: '瓦利为巴德尔复仇', en: 'Váli Avenges Baldr', cycle: 'baldr-ragnarok', priority: 'P1', source: 'voluspa', locator: 'st. 32–33', characters: ['character-vali', 'character-hodr'] }),
  ...
  item({ slug: 'tyr-and-garmr', zh: '提尔与加姆', en: 'Týr and Garmr', cycle: 'baldr-ragnarok', priority: 'P1', source: 'proseEddaGylfaginning', locator: 'ch. 51', characters: ['character-tyr', 'character-garmr'] }),
  ...
  item({ slug: 'volsung-and-sword-tree', zh: '沃尔松格与树中神剑', en: 'Völsung and the Sword-Tree', cycle: 'volsung-cycle', priority: 'P0', source: 'volsungaSaga', locator: 'chs. 2–3', characters: ['character-volsung', 'character-sigmund'] }),
  item({ slug: 'signy-and-siggeir', zh: '西格妮与西格盖尔', en: 'Signý and Siggeir', cycle: 'volsung-cycle', priority: 'P0', source: 'volsungaSaga', locator: 'chs. 3–8', characters: ['character-signy', 'character-siggeir', 'character-sigmund'] }),
  item({ slug: 'sigmund-and-sinfjotli', zh: '西格蒙德与辛菲奥特利', en: 'Sigmund and Sinfjötli', cycle: 'volsung-cycle', priority: 'P0', source: 'volsungaSaga', locator: 'chs. 7–10', characters: ['character-sigmund', 'character-sinfjotli'] }),
  item({ slug: 'sigmunds-death-and-hjordis', zh: '西格蒙德之死与希奥尔迪斯', en: 'Sigmund’s Death and Hjördis', cycle: 'volsung-cycle', priority: 'P0', source: 'volsungaSaga', locator: 'chs. 11–12', characters: ['character-sigmund', 'character-hjordis', 'character-sigurd'] }),
  item({ slug: 'andvari-gold', zh: '安德瓦里与被诅咒的黄金', en: 'Andvari’s Gold', cycle: 'volsung-cycle', priority: 'P0', source: 'reginsmal', locator: 'st. 1–26', characters: ['character-andvari', 'character-ottr', 'character-hreidmar', 'character-fafnir'], objects: ['object-norse-andvaranaut'] }),
  ...
  item({ slug: 'sigurd-and-sigrdrifa', zh: '西格尔德与西格德里法', en: 'Sigurd and Sigrdrífa', cycle: 'volsung-cycle', priority: 'P0', source: 'sigrdrifumal', locator: 'st. 1–37', characters: ['character-sigurd', 'character-brynhildr'] }),
  ...
  item({ slug: 'gudrun-and-atli', zh: '古德伦与阿特利', en: 'Guðrún and Atli', cycle: 'volsung-cycle', priority: 'P0', source: 'atlakvida', locator: 'st. 1–46', characters: ['character-gudrun', 'character-atli', 'character-gunnar', 'character-hogni'] }),
  item({ slug: 'gudrun-svanhild-hamdir-sorli', zh: '古德伦、斯万希尔德与哈姆迪尔兄弟', en: 'Guðrún, Svanhildr, Hamðir and Sörli', cycle: 'volsung-cycle', priority: 'P1', source: 'hamdismal', locator: 'st. 1–30', characters: ['character-gudrun', 'character-svanhildr', 'character-hamdir', 'character-sorli'] }),

  // Cycle 08 — Helgi
  item({ slug: 'helgi-hjorvardsson-and-svava', zh: '赫尔吉·希奥尔瓦尔松与斯瓦瓦', en: 'Helgi Hjörvarðsson and Sváfa', cycle: 'helgi-cycle', priority: 'P1', source: 'helgakvidaHjorvardssonar', locator: 'st. 1–51', characters: ['character-helgi-hjorvardsson', 'character-svava'] }),
  item({ slug: 'helgi-hundingsbani', zh: '赫尔吉·洪丁斯巴尼', en: 'Helgi Hundingsbani', cycle: 'helgi-cycle', priority: 'P1', source: 'helgakvidaHundingsbana1', locator: 'st. 1–57', characters: ['character-helgi-hundingsbani', 'character-sigrun', 'character-sinfjotli'] }),
  item({ slug: 'helgi-and-sigrun', zh: '赫尔吉与西格伦', en: 'Helgi and Sigrún', cycle: 'helgi-cycle', priority: 'P1', source: 'helgakvidaHundingsbana2', locator: 'st. 1–51', characters: ['character-helgi-hundingsbani', 'character-sigrun'] }),
  item({ slug: 'helgi-burial-mound', zh: '赫尔吉的葬丘与归来', en: 'Helgi’s Burial Mound', cycle: 'helgi-cycle', priority: 'P1', source: 'helgakvidaHundingsbana2', locator: 'st. 39–51', characters: ['character-helgi-hundingsbani', 'character-sigrun'] }),

  // Cycle 09 — independent traditions
  item({ slug: 'volundr-captive-smith', zh: '沃伦德：被囚的铁匠', en: 'Völundr the Captive Smith', cycle: 'independent-eddic', priority: 'P1', source: 'volundarkvida', locator: 'st. 1–19', characters: ['character-volundr', 'character-nidudr'] }),
  item({ slug: 'volundr-escape', zh: '沃伦德的逃离', en: 'Völundr’s Escape', cycle: 'independent-eddic', priority: 'P1', source: 'volundarkvida', locator: 'st. 20–41', characters: ['character-volundr', 'character-bodvildr'] }),
  item({ slug: 'svipdagr-and-mengloth', zh: '斯维普达格与孟格洛德', en: 'Svipdagr and Menglöð', cycle: 'independent-eddic', priority: 'P1', source: 'svipdagsmal', locator: 'Grógaldr and Fjölsvinnsmál; editorial split to be reviewed', characters: ['character-svipdagr', 'character-groa', 'character-mengloth'] }),
  item({ slug: 'rig-and-social-orders', zh: '里格与社会秩序', en: 'Rígr and Social Orders', cycle: 'independent-eddic', priority: 'P2', source: 'rigsthula', locator: 'selected stanzas', characters: ['character-rigr'] }),
  item({ slug: 'grottasongr', zh: '格罗蒂之歌', en: 'Grottasöngr', cycle: 'independent-eddic', priority: 'P2', source: 'grottasongr', locator: 'selected stanzas' }),
];
