...
const seeds: readonly CharacterSeed[] = [
  ...
  ['ymir', '尤弥尔', 'Ymir', '冰与火之间诞生的原初巨人', ['冰霜', '巨人之躯', '创世材料'], 'monster', ['world-jotunheim', 'world-niflheim'], ['primordial', 'jotunn']],
  ...
  ['surtr', '苏尔特', 'Surtr', '来自火焰边界的巨人', ['火焰之剑', '熔岩', '毁灭'], 'monster', ['world-muspell'], ['jotunn', 'ragnarok']],
  ['gerdr', '葛德', 'Gerðr', '弗雷爱慕的巨人女子', ['金色庭院', '山地', '丰饶'], 'mortal', ['world-jotunheim'], ['jotunn', 'vanir']],
